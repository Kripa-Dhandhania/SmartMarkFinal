...
def migrate_passwords():
    ...
    try:
        cursor.execute("SELECT id, name, password_hash FROM teachers")
        ...
        for teacher in teachers:
            ...
            if not teacher['password_hash']:
                ...
                if name:
                    ...
                    default_password = f"{first_letter}@123"
                    ...
                    updated_count += 1
                    print(f"Updated teacher {teacher['id']} ({name}) with default password.")

        conn.commit()
        print(f"Migration complete. {updated_count} teachers updated.")
